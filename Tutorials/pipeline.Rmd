---
title: "Tutorial of METAFlux"
author: "Yuefan Huang, Kyle Tsai"
date: "10/25/2022"
output:
...
We can also calculate pathway level activity for 142 pathways. For a given pathway, activity level can be calculated as mean fluxes of reactions associated with that pathway.
...
Taken all those key points together, we see Glucose.V1, Glucose.v2, Glucose.V3 are 3 bootstrap samples. One may look at the distribution of all bootstraps to compare b,Epithelial, Myeloid and T cells nutrient uptake profile.
